...
interface CVFormProps {
  ...
  formWidth: number // Added formWidth prop for responsive sizing
}
...
export function CVForm({ cvData, setCVData, formWidth }: CVFormProps) {
  ...
  const handleAISuggestion = (fieldType: string) => {
    setShowAISuggestions(showAISuggestions === fieldType ? null : fieldType)
    // Here you would integrate with an AI service
    console.log(`[v0] AI suggestions requested for: ${fieldType}`)
  }

  const AISuggestionButton = ({ fieldType, className = "" }: { fieldType: string; className?: string }) => (
    <Button
      type="button"
      variant="ghost"
      size="sm"
      onClick={() => handleAISuggestion(fieldType)}
      className={`p-1 h-6 w-6 text-pink-500 hover:text-pink-700 hover:bg-pink-50 ${className}`}
  ...
  const DateInput = ({ value, onChange, placeholder, error }: DateInputProps) => {
            ...
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <AISuggestionButton fieldType="fullName" />
                </div>
                <Input
                  id="fullName"
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <AISuggestionButton fieldType="headline" />
                </div>
                <Input
                  id="headline"
          ...
          <AccordionContent>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <AISuggestionButton fieldType="summary" />
              </div>
              <Textarea
                  ...
                  <CardContent className="space-y-3">
                    <div className={`grid gap-3 ${formWidth > 400 ? "grid-cols-2" : "grid-cols-1"}`}>
                      <div>
                        <div className="flex items-center justify-between">
                          ...
                          <AISuggestionButton fieldType="position" />
                        </div>
                        <Input
                          value={exp.position}
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        ...
                        <AISuggestionButton fieldType="experience-description" />
                      </div>
                      <Textarea
